...
test("init previews without writes and applies idempotent bounded changes", () => {
  ...
  assert.deepEqual(preview.devcontainer, { isolation: "project-devcontainer", action: "preserve", required: true, reopen_required: true, agent_tools: "both", web_access: "hosted-only" });
