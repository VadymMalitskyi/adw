...
Read only the selected phase of PART 2 plus the plan's shared context, and interpret it into one bounded packet per group. Show the complete preview and wait for the user before touching Git:
