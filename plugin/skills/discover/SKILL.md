...
6. Propose:
   ...
   - only from explicit project-owner requirements, optional schema-5 `workflows.work_tracker` policy and project-owned `adw/work-items/*.yaml` profiles defining provider, object type, required/allowed/default fields, and requirement-bearing fields.
