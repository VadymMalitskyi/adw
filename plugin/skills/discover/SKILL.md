...
8. Show the exact proposed diff for `adw.yaml`, `worktrees/docs/architecture.md`, and only the necessary `worktrees/docs/components/<component>.md` files. Preserve unrelated config, historical `changes/`, `SYNC.yaml`, and repository-owned docs.
